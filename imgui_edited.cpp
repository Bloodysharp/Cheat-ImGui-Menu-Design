...
#include <string>
    ...
    bool edited::Tab(bool selected, const char* icon, const ImVec2& size_arg)
    {
        ImGuiWindow* window = GetCurrentWindow();
        ...
        GetWindowDrawList()->AddRect(bb.Min, bb.Max, GetColorU32(c::tab::tab_active_rect, state.bg_alpha), c::elements::rounding, NULL, 1.5);
   ...
   //     GetWindowDrawList()->AddRect(parent_window->DC.CursorPos, parent_window->DC.CursorPos + size_arg, GetColorU32(c::accent), 0);
    ...
    bool edited::Checkbox(const char* label, const char* description, bool* v)
    {
        ...
        GetWindowDrawList()->AddRect(rect.Min, rect.Max, GetColorU32(c::elements::background_rect), c::elements::rounding, NULL, 1.5);
    ...
    bool BeginCombo(const char* label, const char* description, const char* preview_value, int val, bool multi, ImGuiComboFlags flags)
    {
        ...
        GetWindowDrawList()->AddRect(bb.Min, bb.Max, GetColorU32(c::elements::background_rect), c::elements::rounding, NULL, 1.5);
